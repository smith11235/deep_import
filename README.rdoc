...
---
set association id's from deep import models:
delete deep_import_id on models
delete deep_import* models
validate association distribution

---
update query in commit:
- check what kind of sql is being used
	- have queryies for each db type

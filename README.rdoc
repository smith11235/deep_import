---
Deep Import:
* A gem for loading big data with rails using your normal rails syntax
* With standard active record methodology, batch loading becomes a bottleneck
	* database transaction costs are significant
...
* 10 parents have 10 children each, and 10 grandchildren from each child
	* A total of 1110 objects from 3 models
* Rake Task: deep_import:benchmark
	* defined in lib/deep_import/deep_import.rake
* Results:
		mysql running on remote server
    deep_import:
		  4.650000   0.070000   4.720000 (  7.043655)
		classic:
	    4.370000   0.260000   4.630000 (209.035913)
...
Commit:
	...
	- delete deep_import_id on models
		- to flag that they are finished being loaded
	- delete deep_import* models
		- to save space on the database
	- verify what kind of sql is being used
		- raise error if not mysql
		- have queryies for each db type in the future

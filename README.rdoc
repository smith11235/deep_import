...
---
Setup Logic:
	- rails generate all soft models
		- print model file custom, handle polymorphism
			-	print sample model to see what it looks like
			- copy form, add tweaks
		- print generation statements to script
		- tell user to run it, and db:migrate
		- destroy method to remove deep import

---
Generate dummy code based on config:
	- as example load code

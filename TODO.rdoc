---
break lib/deep_import/deep_import.rake up:
	- lib/tasks/benchmark.rake
		- application examples
		- original: deep_import tasks only

	- SPec Setup:
		- individual rake tests should be runnable
...
testing:
		...
		- commit
			- post sample load:
				...
				- validate with:
					- id distribution: fast
					- exact verification: slow
